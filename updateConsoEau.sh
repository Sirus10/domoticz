...
-d "_username=$SDEI_EMAIL&_password=$SDEI_PASSWD&_csrf_token=$csrftoken&signin[username]=$SDEI_EMAIL&signin[password]"  |grep -e "se déconnecter" -e "Connexion en cours" > /dev/nul
CR=$?
if [[ "$CR" == "0" ]] then
 echo "  - LOGIN OK" 
# else   
