...
curl -f "http://api.wunderground.com/api/6fae56bbbe7f85f3/hourly/lang:FR/q/France/$TOWN.xml" -o /tmp/weather$TOWN.out
...
x=12 # Hour
proba_rain=`grep "pop" /tmp/weather$TOWN.out.out | sed "s/<pop>// "|sed "s/<\/pop>//" |awk 'NR==12' `
