...
then
   val = tonumber(otherdevices_svalues['Niveau eau temp']);
   ...
   if (val > tonumber(hMax) or val < tonumber(1) ) -- uniquement les valeur correcte
   then  
    print('Niveau eau distance meusurée : '..val.. 'cm  mauvaise lecture' ); 
   else 
	...
	commandArray['UpdateDevice']='6620|0|'..vPein;		-- mise a jour du capteur Litre 'Cuve' qui a pour idx 6620 pour moi
